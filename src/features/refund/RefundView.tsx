...
const RefundView = () => {
  return (
    <div>
      <HeroSection
        title="Refund Policy"
        description="Please read these refund policy carefully before using Our Service."
        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-[#6C6C6C] mb-8">
              At DevX, we strive to deliver high-quality custom AI solutions.
              Due to the nature of milestone-based and service-driven projects,
            ...
            <div className="space-y-8">
              <section>
                ...
                <ul className="space-y-3 text-[#6C6C6C]">
                  <li>
                    Payments made for completed milestones are non-refundable.
                  </li>
                  <li>
                    If a project is canceled by the client before a milestone
                    begins, any unused milestone payments will be refunded.
                  </li>
                </ul>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#6C6C6C] mb-4">
                  2. Custom AI Products
                </h2>
                <ul className="space-y-3 text-[#6C6C6C]">
                  <li>
                    Since AI products are customized, refunds are not applicable
                    once development begins.
                  </li>
                  <li>
                    Refunds may only be considered if DevX fails to deliver as
                    per the agreed-upon scope.
                  </li>
                </ul>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#6C6C6C] mb-4">
                  3. Subscription or SaaS Products (if applicable)
                </h2>
                <p className="text-[#6C6C6C]">
                  Refunds for subscription-based services are available only if
                  requested within the first 7 days of initial purchase.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-[#6C6C6C]">
                  All disputes will be handled on a case-by-case basis. Clients
                  are encouraged to contact support for resolution.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="text-[#6C6C6C] text-xl flex items-center">
