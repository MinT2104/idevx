            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-[#6C6C6C]">
                  DevX provides custom AI solutions and products tailored to
                  client needs. Services may include consultation, model
                  customization, integration, and delivery of AI-powered
                  products.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3 text-[#6C6C6C]">
                  <li>
                    Payments are made in milestones, as agreed upon before
                    project initiation.
                  </li>
                  <li>
                    Failure to pay a milestone invoice on time may result in
                    project suspension.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3 text-[#6C6C6C]">
                  <li>
                    Provide accurate project requirements and necessary data.
                  </li>
                  <li>
                    Ensure that shared data complies with legal standards.
                  </li>
                  <li>Use DevX products/services only for lawful purposes.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3 text-[#6C6C6C]">
                  <li>
                    DevX retains ownership of core AI frameworks, tools, and
                    methods.
                  </li>
                  <li>
                    Clients receive a license or ownership of custom
                    deliverables as per the signed agreement.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-[#6C6C6C]">
                  Both parties agree to keep project details, data, and
              ...
              <section>
                ...
                <p className="text-[#6C6C6C]">
                  DevX is not liable for indirect, incidental, or consequential
                  damages arising from the use of its services.
                </p>
              </section>
